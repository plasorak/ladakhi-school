        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="font-bold text-sky-900 mb-2">Address</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-sky-900 mb-2">Phone</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
                <a href="tel:+917051120583" className="hover:text-sky-700 transition-colors block">
                  +91 70511 20583
                </a>
                <a href="tel:+919622979114" className="hover:text-sky-700 transition-colors block">
                  +91 9622979114
                </a>
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-sky-900 mb-2">Email</h3>
              <a
              ...
              <p className="text-slate-500 text-xs mt-2">We also have Instagram &amp; Facebook pages.</p>
            </div>
          </div>
        </div>
      </section>
